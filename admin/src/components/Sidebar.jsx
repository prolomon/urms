...
export default function Sidebar({ onClose }) {
  ...
  if (partner) {
    navItems = [
      ...
      { href: "/partner/agents", label: "Agents", icon: <Users size={18} /> },
      {
        href: "/partner/revenue-assurance",
        label: "Assurance",
        icon: <ShieldCheck size={18} />,
      },
      { href: "/partner/wallet", label: "Wallet", icon: <Wallet2 size={18} /> },
      {
        href: "/partner/help-center",
        label: "Help Center",
